...
public class StreamFile {
    ...
    public static void writeBytes(byte[] array) {
        ...
        try {
            ...
            writer = new FileOutputStream(Environment.getExternalStorageDirectory()+"/CCCCx264data.h264", true);
            writer.write(array);
            writer.write('\n');
...
//        Log.i(TAG, "writeContent: "+sb.toString());
        ...
        try {
            // 打开一个写文件器，构造函数中的第二个参数true表示以追加形式写文件
            writer = new FileWriter(Environment.getExternalStorageDirectory()+"/CCCCcodecH264.txt", true);
